...
#            558H67 => 0558-H-00067-0000-00
        ...
        self.assertEqual(convert_blocklot_to_pin("1360A268"), "1360A00268000000")
        self.assertEqual(convert_blocklot_to_pin("352B94"), "0352B00094000000")
        self.assertEqual(convert_blocklot_to_pin("159C221"), "0159C00221000000")
        self.assertEqual(convert_blocklot_to_pin("159D250"), "0159D00250000000")
        self.assertEqual(convert_blocklot_to_pin("2014E81"), "2014E00081000000")
        self.assertEqual(convert_blocklot_to_pin("233F181"), "0233F00181000000")
        self.assertEqual(convert_blocklot_to_pin("214G46"), "0214G00046000000")
        self.assertEqual(convert_blocklot_to_pin("558H67"), "0558H00067000000")
        self.assertEqual(convert_blocklot_to_pin("2013J377"), "2013J00377000000")
        self.assertEqual(convert_blocklot_to_pin("214L128"), "0214L00128000000")
        self.assertEqual(convert_blocklot_to_pin("430M330"), "0430M00330000000")
        self.assertEqual(convert_blocklot_to_pin("215N56"), "0215N00056000000")
        self.assertEqual(convert_blocklot_to_pin("161P50"), "0161P00050000000")
        self.assertEqual(convert_blocklot_to_pin("214R184"), "0214R00184000000")
        self.assertEqual(convert_blocklot_to_pin("161S334"), "0161S00334000000")
...
#                                         ^
        self.assertEqual(convert_blocklot_to_pin("232L374 2"), "0232L00374000200")
...
#                                            ^
        self.assertEqual(convert_blocklot_to_pin("233J211 2"), "0233J00211000002")

        self.assertEqual(convert_blocklot_to_pin("214L167 1"), "0214L00167000100")
        self.assertEqual(convert_blocklot_to_pin("236G99 A"), "0236G00099000A00")
        ...
        self.assertEqual(convert_blocklot_to_pin("160A154 307"), "0160A00154030700")
        self.assertEqual(convert_blocklot_to_pin("160A132 104"), "0160A00132010400")
        self.assertEqual(convert_blocklot_to_pin("160J60 708"), "0160J00060070800")
        self.assertEqual(convert_blocklot_to_pin("329G20 27D"), "0329G00020027D00")
        self.assertEqual(convert_blocklot_to_pin("58P100 T1"), "0058P0010000T100")

        # Two-digit number at the end:
        self.assertEqual(convert_blocklot_to_pin("215J110 01"), "0215J00110000001")
        ...
        self.assertEqual(convert_blocklot_to_pin("307G395 99"), "0307G00395000909")
        self.assertEqual(convert_blocklot_to_pin("99B175 21"), "0099B00175000201")
        self.assertEqual(convert_blocklot_to_pin("10G235 21"), "0010G00235000201")
        # Completely anomalous and difficult to categorize:

        # Four alphanumeric characters after the space:
        self.assertEqual(convert_blocklot_to_pin("236G132 A000"), "0236G00132000A00") #<== Possibly this one is a case of human error, but it has happened for many different properties (~25). All cases (which occurred between 2012 and 2014 inclusive), have been manually checked to verify that the new rule concocted to handle this case holds for all such Block Lot numbers.

        self.assertEqual(convert_blocklot_to_pin("37N210 A463"),"0037N00210A46300")
        # Four-digit number after the space:
        self.assertEqual(convert_blocklot_to_pin("100C50 4099"), "0100C00050409900")
